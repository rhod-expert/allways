      ...
      <div className="max-w-3xl mx-auto px-4">
        ...
        <article className="prose prose-gray max-w-none">
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            El presente sitio web es propiedad y esta operado por San Jose Import Export S.A., empresa constituida y registrada conforme a las leyes de la Republica del Paraguay, con RUC 80056321-2, con domicilio legal en Ciudad del Este, Departamento de Alto Parana, Paraguay.
          </p>

          <h2 className="text-xl font-bold text-allways-navy mt-8 mb-3">2. Objeto del sitio</h2>
          <p className="text-gray-600 leading-relaxed mb-4">
            Este sitio web tiene como objetivo exclusivo la gestion de la promocion "Promocion Allways 2026", incluyendo el registro de participantes, la carga de facturas, la consulta de cupones y la comunicacion de resultados de sorteos.
          </p>

          <h2 className="text-xl font-bold text-allways-navy mt-8 mb-3">3. Condiciones de la promocion</h2>
          <p className="text-gray-600 leading-relaxed mb-2">
            La participacion en la promocion esta sujeta a las siguientes condiciones, sin perjuicio de lo establecido en las Bases y Condiciones:
          </p>
          <ul className="list-disc list-inside text-gray-600 space-y-1 mb-4">
            <li>Esta promocion es valida unicamente en el territorio de la Republica del Paraguay.</li>
            <li>No se requiere una compra minima; basta con la adquisicion de productos ALLWAYS para participar.</li>
            <li>La promocion no es acumulable con otras promociones.</li>
            <li>Los premios no son transferibles ni canjeables por dinero en efectivo.</li>
            <li>Las imagenes de los premios son ilustrativas y pueden variar en color o modelo respecto del producto entregado.</li>
          </ul>

          <h2 className="text-xl font-bold text-allways-navy mt-8 mb-3">4. Propiedad intelectual</h2>
          <p className="text-gray-600 leading-relaxed mb-4">
          ...
          <h2 className="text-xl font-bold text-allways-navy mt-8 mb-3">5. Condiciones de uso</h2>
          ...
          <h2 className="text-xl font-bold text-allways-navy mt-8 mb-3">6. Limitacion de responsabilidad</h2>
          <p className="text-gray-600 leading-relaxed mb-4">
          ...
          <h2 className="text-xl font-bold text-allways-navy mt-8 mb-3">7. Enlaces externos</h2>
          <p className="text-gray-600 leading-relaxed mb-4">
          ...
          <h2 className="text-xl font-bold text-allways-navy mt-8 mb-3">8. Modificaciones</h2>
          <p className="text-gray-600 leading-relaxed mb-4">
          ...
          <h2 className="text-xl font-bold text-allways-navy mt-8 mb-3">9. Legislacion aplicable</h2>
          <p className="text-gray-600 leading-relaxed mb-4">
            El presente aviso legal se rige por las leyes de la Republica del Paraguay. Para cualquier controversia derivada del uso del sitio web, las partes se someten a la jurisdiccion exclusiva de los Tribunales Ordinarios de la ciudad de Ciudad del Este, Departamento de Alto Parana, Paraguay.
          </p>

          <h2 className="text-xl font-bold text-allways-navy mt-8 mb-3">10. Contacto</h2>
          <p className="text-gray-600 leading-relaxed mb-4">
            Para consultas legales, el usuario puede comunicarse a: legal@sanjoseimport.com.py o a la direccion fisica de San Jose Import Export S.A. en Ciudad del Este, Paraguay.
          </p>
